                  ...
                  <div class="panel panel-default ">
                          ...
                          <ul class="dropdown-menu dropdown-menu-right">
                            <li>
                              <ul class="dropdown-settings">
                                <li><a href="#" data-toggle="modal" data-target="#ModalDel">
                                  <em class="fa fa-cog"></em> Hapus
                                </a></li>
                    ...
                    <div class="panel-body">
                      ...
                      <div class="col-md-12 no-padding">
                        <table border="0" id="data" class="table table-bordered table-striped table-scalable" cellpadding>
                        <thead>
                					<tr align="center">
                						<th></th>
                						<th>Prestasi</th>
                				...
                				<tbody>
                					<?php
                						$query = mysql_query ("SELECT * FROM prestasi where id_user='$jumlah1[id_user]' order by prestasi ASC");
                						if($query == false){
                ...
                <div id="ModalFoto" class="modal fade" role="dialog">
                		<div class="modal-dialog">
                          ...
                          <div class="panel-body">Ubah Foto Profil
                            <form action="../comp/uploadpros.php" enctype="multipart/form-data" class="form-horizontal" method="post">
