...
<head>
	...
	<![endif]-->
	   <script src="../assets/aset/plugins/jQuery/jQuery-2.1.4.min.js"></script>
    <!-- Bootstrap 3.3.5 -->
    <script src="../assets/aset/bootstrap/js/bootstrap.min.js"></script>
    <!-- DataTables -->
    ...
    <!-- SlimScroll -->
    <script src="../assets/aset/plugins/slimScroll/jquery.slimscroll.min.js"></script>
    <!-- FastClick -->
