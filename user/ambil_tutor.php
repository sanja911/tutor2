...
$sql2 = "select * from kelas where id='$id'";
...
$cek1 = mysql_num_rows(mysql_query("SELECT * FROM ambil_tutor WHERE id_mapel='$data1[id_mapel]' and id_user='$data[id_user]'"));
$cek2 = mysql_num_rows(mysql_query("SELECT * FROM ambil_tutor WHERE id_kelas='$data2[id_kelas]' and id_user='$data[id_user]'"));
...
$sql= mysql_query("INSERT INTO ambil_tutor VALUES ('$newID','$data[id_user]','$data1[id_user]','$data1[id_mapel]','$data2[id_kelas]')");
	if ($sql){
