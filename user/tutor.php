...
?>
  ...
  <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
      ...
      <li class="parent "><a data-toggle="collapse" href="#sub-item-1">
          ...
          <li><a class="active" href="tutor.php">
  ...
  <div class="modal fade" id="show">
    ...
    <div class="row">
          ...
          <table id="data3" class="table table-bordered table-striped table-scalable">
            <?php
              include "../comp/tbl_tutor.php";
            ?>
                  </table>
    <br></br>
  </div>
