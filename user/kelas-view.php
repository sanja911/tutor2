...
<body>
  ...
  $hasil  = mysql_query($query);
	...
	$query2  = "SELECT * FROM ambil_tutor join mapel on ambil_tutor.id_mapel=mapel.id_mapel where id_kelas='$id'";
  ...
  <div class="modal fade" id="hapus">
    ...
    <div class="row">
			<div class="col-md-12">
              ...
              Selamat Datang di Kelas <?php echo $id;?> Matakuliah <?php echo $out2['mapel'];?>
						<span class="pull-right clickable panel-toggle panel-button-tab-left"><em class="fa fa-toggle-up"></em></span></div>
					<div class="panel-body">
						
    <table id="data" class="table table-bordered table-striped table-scalable">
            <?php
              include "../comp/tbl_materi-view.php";
            ?>
                  </table>
    <br></br>
  </div>
