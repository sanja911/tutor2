    ...
    $ekstensi_diperbolehkan	= array('png','jpg');
       ...
       if(in_array($ekstensi, $ekstensi_diperbolehkan) === true){
         if($ukuran < 104407000){
           ...
           if($query){
              $_SESSION['sukses']="<div class='alert bg-info' role='alert'><em class='fa fa-lg fa-warning'>&nbsp;</em> Upload sukses <a href='#' class='pull-right'><em class='fa fa-lg fa-close'></em></a></div>";
