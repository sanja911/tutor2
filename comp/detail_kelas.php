<?php
  include "koneksi.php";
	$id=$_GET['id'];
  $sql1 = "select * from ambil_tutor where id_kelas='$id'";
	$hasil1 = mysql_query($sql1);
	$data1  = mysql_fetch_array($hasil1);
	$modal=mysql_query("SELECT * FROM ambil_tutor WHERE id_kelas='$id'");
...
<div class="modal-dialog">
    <div class="modal-content abt-w3l">
                 ...
                 <div class="col-md-4 col-sm-4 col-xs-4">
                   ...
                   <div class="form-group"><label>Data Siswa <?php echo $data1['id_kelas'];?></label>
                     <table id="data" class="table table-bordered table-striped table-scalable">
                     <?php
                     $query = mysql_query ("SELECT * FROM user join ambil_tutor on user.id_user=ambil_tutor.id_user where ambil_tutor.id_kelas='$data1[id_kelas]' order by user.id_user ASC");
                       if($query == false){
